            ...
            <div class="row bg-white shadow-sm px-3">
                ...
                <div class="col-6 d-flex align-items-center py-3">
                    <img src="{{ $barangay_list->image ? asset('brgy_images/' . $barangay_list->image) : asset('assets/img/offices/default.jpg') }}"
                        class="rounded-circle border border-success border-2 me-3" width="150" height="150"
                        alt="Image of {{ $barangay_list->brgy_name }}" style="object-fit: cover;">
                    <div>
                ...
                <div class="row px-4">
                    <div class="col-3">
                        <h6><b>Total :</b> 1000</h6>
                    </div>
                    <div class="col-3">
                        <h6><b>Farmers:</b> 1000</h6>
                    </div>
                    <div class="col-3">
                        <h6><b>Household:</b> 2500</h6>
                    </div>
                    <div class="col-3">
                        <h6><b>Rotor:</b> 20</h6>
                    </div>
                    <div class="col-3">
                        <h6><b>Major Crops:</b> Rice, Corn</h6>
                    </div>
                </div>
            </div>
        </div>
