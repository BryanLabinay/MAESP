...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center position-sticky top-0 p-1" style="z-index: 1000;">
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Services</span> <i
                        ...
                        @endphp
                            ...
                            <li><a href="{{ route('user.service', ['id' => $service->id]) }}">{{ $service->service_name }}</a></li>
